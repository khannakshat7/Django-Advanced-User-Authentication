...
class SignUpView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        if settings.ENABLE_USER_ACTIVATION:
            ...
            print(code)
            messages.success(
                request, _('You are signed up. To activate the account, follow the link sent to the admin mail.'))
        else:
...
class ResendActivationCodeView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, _('A new activation code has been sent to admin email address.'))
